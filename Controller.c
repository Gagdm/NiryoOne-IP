...
int main(int argc, char* argv[]) {
    ...
    while (!feof(file)) {
        ...
        //seleciona a tecla a ser apertada na urna eletrônica para a cada das unidades
        switch (ultimoDigito) {
        case 0:
